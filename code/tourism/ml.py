...
y_pred_lgbm, eval_lgbm = train_and_save_model(lgbm_model, "LGBM", X_train, y_train, X_test, y_test, horizon, freq, look_back, retrain, 'tourism')

# XGBoost
xgb_model = XGBModel()
y_pred_xgb, eval_xgb = train_and_save_model(xgb_model, "XGB", X_train, y_train, X_test, y_test, horizon, freq, look_back, retrain, 'tourism')
...
ensemble_metadata_path = f"models/tourism/ml_{freq.lower()}/ensemble_metadata.json"
ensemble_metadata = {
    "model_name": "Ensemble",
